  ...
  return (
    <div className="container mx-auto my-8">
      ...
      <div className="my-4">
        ...
        {todayNotes.map(note => (
          <div className={`border-2 p-2 mb-2 ${note.category === "Health" ? "border-red-500" : note.category === "Project" ? "border-purple-500" : note.category === "Programming" ? "border-green-500" : "border-gray-500"}`}>
